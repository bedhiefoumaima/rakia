  ...
  <Card.Body>
    ...
    <Card.Text>
      ...
      <h3> fullName </h3><input onChange = {this.handleChange}/>
            ...
            <h3> profession </h3><input onChange = {this.handleChange}/> <br/>
